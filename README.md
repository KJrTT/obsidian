...
![[Pasted image 20250227080838.png]]

![[Pasted image 20250227081010.png]]

![[Pasted image 20250227081324.png]]

![[Pasted image 20250227081525.png]]

![[Pasted image 20250227081735.png]]

![[Pasted image 20250227081953.png]]

###### Структурный паттерн --> декоратор

![[Pasted image 20250227082129.png]]

![[Pasted image 20250227082412.png]]

![[Pasted image 20250227082543.png]]

![[Pasted image 20250227082851.png]]

![[Pasted image 20250227083106.png]]


###### Структурный паттерн --> компоновщик

![[Pasted image 20250227084324.png]]

![[Pasted image 20250227084420.png]]

![[Pasted image 20250227084622.png]]

![[Pasted image 20250227085119.png]]

![[Pasted image 20250227085230.png]]


###### Структурный паттерн --> Фасад

![[Pasted image 20250227090016.png]]

![[Pasted image 20250227090718.png]]

![[Pasted image 20250227090606.png]]


###### Структурный паттерн --> Мост

![[Pasted image 20250228081536.png]]
(абстракция) --> интерфейс

![[Pasted image 20250228082055.png]]
###### Структурный паттерн --> заместитель

![[Pasted image 20250228083817.png]]

![[Pasted image 20250228084106.png]]

![[Pasted image 20250228084648.png]]

![[Pasted image 20250228084910.png]]

###### Структурный паттерн --> Легковес / Приспособленец

![[Pasted image 20250228085340.png]]

![[Pasted image 20250228085955.png]]

 ![[Pasted image 20250228090204.png]]

###### Поведенческие паттерны
![[Pasted image 20250307082008.png]]

###### Поведенческий паттерн --> Команда

![[Pasted image 20250307081047.png]]

![[Pasted image 20250307081127.png]]

![[Pasted image 20250307081213.png]]

![[Pasted image 20250307082949.png]]

###### Поведенческий паттерн --> Цепочка обязанностей 
![[Pasted image 20250307083716.png]]

![[Pasted image 20250307084940.png]]

![[Pasted image 20250307085427.png]]

###### Поведенческий паттерн --> Снимок 

![[Pasted image 20250307085558.png]]

![[Pasted image 20250307091021.png]]

![[Pasted image 20250307091157.png]]

###### Поведенческий паттерн --> Итератор

![[Pasted image 20250307120741.png]]

![[Pasted image 20250307121232.png]]

![[Pasted image 20250307121611.png]]

###### Поведенческий паттерн --> Посредник

![[Pasted image 20250307121834.png]]

![[Pasted image 20250307122451.png]]

![[Pasted image 20250307122747.png]]
###### Паттерн --> Посетитель

![[Pasted image 20250313085016.png]]

![[Pasted image 20250313085101.png]]

![[Pasted image 20250313085117.png]]

![[Pasted image 20250313085149.png]]

###### Паттерн --> Шаблонный метод

![[Pasted image 20250313091743.png]]

![[Pasted image 20250313091755.png]]

![[Pasted image 20250313091820.png]]


###### Поведенческий паттерн --> наблюдатель

![[Pasted image 20250314081213.png]]

![[Pasted image 20250314081511.png]]

![[Pasted image 20250314081915.png]]

![[Pasted image 20250314082028.png]]

###### Поведенческий паттерн --> Стратегия

![[Pasted image 20250314082305.png]]

![[Pasted image 20250314083004.png]]

![[Pasted image 20250314083230.png]]

###### Поведенческий паттерн --> шаблонный метод

![[Pasted image 20250314083627.png]]

![[Pasted image 20250314084216.png]]

![[Pasted image 20250314084604.png]]

###### Поведенческий паттерн --> Посетитель

![[Pasted image 20250314085052.png]]

![[Pasted image 20250314085722.png]]

![[Pasted image 20250314090021.png]]

###### Поведенческий паттерн --> Состояние

![[Pasted image 20250314094528.png]]

![[Pasted image 20250314095404.png]]

![[Pasted image 20250314095618.png]]


###### Многослойная архитектура
-- Принцип проектирования ПО, при котором функциональность разделяется на логически-изолированные слои.

Слой --> логическое разделение компонентов.
Уровень --> Физическое разделение инфраструктуры.

Presentation Layer --> Отвечает за взаимодействие пользователя с системой. (Слой представления)
Получает от пользователя данные и передаёт их дальше. И наоборот, когда получает данные от Business Layer, то отдаёт их пользователю.

Business Layer --> (Слой бизнес-логики) Содержит правила обработки данных, вычисления, проверку входных данных, управление процессами и т.д. Получает какие-то данные от слоя представления, может передавать данные в след. слой. И наоборот.

Data Layer --> (слой доступа к данным) непосредственно взаимодействует с БД / файлами / текстами и т.д. Получает от бизнес-логики запрос что-то сделать с данными (Изменить, удалить , получить и т.д.)

Плюсы:
	- Любой из слоёв можно менять и это не повлияет на другие слои.
	-
